...
def teststrip_ai_think_tags_no_tags():
...
def teststrip_ai_think_tags_multiple():
...
def teststrip_ai_think_tags_multiline():
...
def teststrip_ai_think_tags_real_format():
...
def teststrip_ai_think_tags_real_format_no_tags():
...
def teststrip_ai_think_tags_real_format_multiple():
