...
| 文档 | 看什么 |
|---|---|
| [2026-07-25](release-notes/2026-07-25.md) | 面向用户与管理员的新增、优化和修复说明 |

### 架构与需求
| 文档 | 看什么 |
|---|---|
| [项目需求.md](项目需求.md) | 需求规格 + 系统架构（§2 含架构图、组件职责、**核心数据流、6 张时序图**）|
| [技术投标文件查重功能-需求设计与开发计划.md](技术投标文件查重功能-需求设计与开发计划.md) | 标书查重已确认需求、数据/API/代理/权限设计、开发计划与验收标准 |
| [技术投标文件查重第二阶段能力规划.md](技术投标文件查重第二阶段能力规划.md) | 第二阶段能力边界、实施顺序、数据流、评测指标与发布门槛 |
...
| [查重规则测试记录-2026-07-26.md](查重规则测试记录-2026-07-26.md) | D001-D010 规则补全、逐文件测试、迭代与验收边界 |
...
- [`rules-duplicate/`](rules-duplicate/) — 技术投标文件查重规则集（D001-D010，共 71 个检查项）
