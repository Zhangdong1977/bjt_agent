...
第二阶段把当前“Markdown 段落级 A/B 查重”升级为“有覆盖度、有来源、有结构、有多模态证据、可扩展到多份投标文件的查重系统”。
...
| 来源 | 仅 A/B 投标文件，来源依赖断言降级为 unknown | 无招标文件/公共资料证据链和来源快照 |
