...
const allMenuItems = [
  ...
  {
    key: '/home/system-status',
    label: '系统状态',
    subtitle: '查看节点运行状态与任务队列',
    iconSvg:
      '<svg viewBox="0 0 1024 1024" width="20" height="20"><path fill="currentColor" d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm0 768c-176.7 0-320-143.3-320-320s143.3-320 320-320 320 143.3 320 320-143.3 320-320 320zm32-464v-48c0-4.4-3.6-8-8-8h-48c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8h48c4.4 0 8-3.6 8-8zm0 272V400c0-4.4-3.6-8-8-8h-48c-4.4 0-8 3.6-8 8v240c0 4.4 3.6 8 8 8h48c4.4 0 8-3.6 8-8z"/></svg>',
    internalOnly: true,
  },
]
